 (function($){
    ...
    function mainMap() {
      ...
      var locations = [
        [ locationData('single-property-page-1.html','$275,000','$520 / sq ft','app/img/listing/listing-01.jpg','Eagle Apartmets',"9364 School St. Lynchburg, NY "), 40.7427837, -73.11445617675781, 1, markerIcon ],
        [ locationData('single-property-page-1.html','$425,000','$770 / sq ft','app/img/listing/listing-04.jpg','Selway Apartments',"33 William St. Northbrook, IL "), 40.94401669296697, -74.16938781738281, 3, markerIcon ],
      ];
      ...
      {
        textColor: 'white',
        url: 'app/img/listing/map-icon.png',
        height: 50,
        width: 50
      }
      ];
